...
export class WorkerTile {
    ...
    async parse(data: VectorTileLike, layerIndex: StyleLayerIndex, availableImages: Array<string>, actor: IActor, subdivisionGranularity: SubdivisionGranularitySetting, _perfMark?: (s?: string) => void): Promise<WorkerTileResult> {

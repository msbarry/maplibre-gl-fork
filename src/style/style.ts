...
export class Style extends Evented {
    ...
    _updatePlacement(transform: ITransform, showCollisionBoxes: boolean, fadeDuration: number, crossSourceCollisions: boolean | object, forceFullPlacement: boolean = false) {
